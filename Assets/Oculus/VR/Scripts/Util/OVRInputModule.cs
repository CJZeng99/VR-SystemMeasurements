...
namespace UnityEngine.EventSystems
{
    ...
    public class OVRInputModule : PointerInputModule
    {
        ...
        public Transform rayTransformEnd;
...
#region PointerEventData pool
        ...
        virtual protected MouseState GetGazePointerData()
        {
            ...
            Vector3 rayForward = Vector3.Normalize(rayTransformEnd.position - rayTransform.position);
            leftData.worldSpaceRay = new Ray(rayTransform.position, rayForward);
